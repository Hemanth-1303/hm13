...
public class MakeMyTripRunner {
    ...
    public static void main(String[] args) {
        ...
        dto.setPassengerName("Prasanna");
        dto.setEmail("prasanna12@gmail.com");
        dto.setContactNumber("9876543210L");
        dto.setDepartureCity("Bangalore");
        dto.setArrivalCity("Hyderabad");
        dto.setTravelDate("2025-04-28");
